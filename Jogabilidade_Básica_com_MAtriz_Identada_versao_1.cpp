...
// uma tela de derrota é mostrada.
...
int main () {
    ...
    //VARIÁVEL PONTOS FAZ A GONTAGEM DA PONTUAÇÃO
    int pontos=0;
    //FIM DA DECLARAÇÃO DA VARIÁVEL CONTAGEM DE PONTOS.
    ...
    for(int k=0;k<turnos;k++){
        ...
        //EXIBIÇÃO DA SENHA A FIM DE TESTES
        for(int j=0;j<pinos;j++){
                cout<<senha[j];
            }
        cout<<endl;
    ...
    if(ganhar==true){
        ...
        cout<<"Você Ganhou! Sua pontuação é de: "<<pontos<<" pontos!"<<endl;
