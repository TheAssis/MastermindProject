// Esse código é a Matrix_com_teste_versao_1. Ele printa a matriz em loop. Também é responsável por analisar
...
int main () {
    ...
    //VETOR QUE GERA A ANÁLISE DO SISTEMA
    ...
    cout << "Master Mind 2017" << endl;
        ...
        for (int i=0; i<turnos; i++) {
            ...
            //FIM DO MOSTRAR A ANÁLISE DA SENHA
